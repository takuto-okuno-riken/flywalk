...
%    checkLargeSmoothingPoltcompByRoinum(vslabels);
    ...
    checkNeuronVsSynapseByRoinum(vslabels); % TODO: recalc all

    % check correlation result in each ROI num (s30 & s80, roi 100 to 10000, '' & poltcomp)
    % roitype: Cm,DistKm
    checkSmoothingNuisanceByRoinum(vslabels); % TODO: recalc 10000
...
function checkSmoothNuisanceFlyWireResult50(vslabels)
    ...
    smooth = {'', 's10', 's20', 's30', 's40', 's50', 's60', 's70', 's80'};
    nuisance = {''};
    roitypes = {'flyemroi','flyemroi_fw','hemiDistKm50','hemiDistKm50_fw','hemiDistKm50_avg'};
